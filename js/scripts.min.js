(function(a){a(document).ready(function(){if ($(window).width() > 900) {$('.top-section.has-video').prepend('<div class="video-container"><iframe src="https://www.youtube.com/embed/D13x0WJhMfU?controls=0&autoplay=1&loop=1&modestbranding=1&rel=0&" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>');}a(window).load(function(){a("#st-container").removeClass("disable-scrolling");a("#loading-animation").fadeOut();a("#preloader").delay(350).fadeOut(800);var b=document.createElement("script");b.type="text/javascript";b.async=!0;b.src="https://apis.google.com/js/platform.js";var d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(b,d);equalheight(".same-height")});1500<a(window).width()&&a(".effect-wrapper").addClass("col-lg-3");768>a(window).width()&&
